...
public class RentSystemTest {
    ...
    @Test
    @Order(7)
    public void testVehicleMaintenanceForCar() {
    ...
    @Test
    @Order(8)
    public void testVehicleMaintenanceForVan(){
    ...
    @Test
    @Order(9)
    public void testCompleteMaintenanceForCAR() {
    ...
    @Test
    @Order(10)
    public void testCompleteMaintenanceForVan(){
